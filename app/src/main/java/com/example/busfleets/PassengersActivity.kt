...
class PassengersActivity : AppCompatActivity() {
    ...
    private fun loadRecyclerView(){
        ...
        free_places.adapter = PassengerListAdapter(bussPassengerList = placeFreeList, onPassengerClick = {
        ...
        AsyncTask.execute{
            ...
            runOnUiThread {
                busy_places.adapter = passengers?.let {
                    PassengerListAdapter(bussPassengerList = it,
    ...
    private fun deletePassenger(passenger: BussPassenger) {
        AsyncTask.execute {
    ...
    private fun fillWindow(view: View, passenger: BussPassenger){
